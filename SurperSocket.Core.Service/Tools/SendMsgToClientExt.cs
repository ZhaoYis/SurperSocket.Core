...
using SurperSocket.Core.Service.Models;
...
namespace SurperSocket.Core.Service.Tools
{
    ...
    public static class SendMsgToClientExt
    {
        ...
        public static void Send(this CustomSession session, CustomCommand command, string msg)
        {
        ...
        /// <param name="command">命令</param>
        /// <param name="msg">数据包</param>
        public static void SendToAll(CustomCommand command, string msg)
        {
